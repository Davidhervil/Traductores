...
reservados = {"+":'TkSuma' , "-":'TkResta' , "*":'TkMult' , '/':'TkDiv', '%':'TkMod' , "/\\":'TkConjuncion' ,\
 "\/":':TkDisyuncion' , "not":'TkNegacion' , "<":'TkMenor', "<=":'TkMenorIgual' , ">":'TkMayor', ">=":'TkMayorIgual'\
, "=":'TkIgual', "++":'TkSiguienteCar' , "-":'TkAnteriorCar' , "#":'TkValorAscii', "::":'TkConcatenacion',\
 "$":'TkRotacion', "?":'TkTrasposicion',"begin":"TkBegin"}
